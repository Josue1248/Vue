<template>
	<main id="app">
		<Menu :products="this.products" v-on:productChange="handleProductChange"/>
		<Order :products="this.order"/>
	</main>
</template>
...
export default {
	...
	methods: {
		handleProductChange: function(item){
			if(item.active)
				this.order.push(item);
			else
				this.order = this.order.filter(product => product.name != item.name)
		}
	}
}
</script>
